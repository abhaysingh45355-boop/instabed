...
#define COLOR_RAMP(colors, factor, finalColor) { \\
  ...
  float lerpFactor = (factor - currentColor.position) / (nextColor.position - currentColor.position); \\
...
export default function Aurora({
    colorStops = ['#3B82F6', '#14B8A6', '#2563EB'],
    amplitude = 1.0,
    blend = 0.5,
    speed = 1.0,
    className = '',
    ...
    useEffect(() => {
        ...
        const colorValues = colorStops.map((c) => {
            const clr = new Color(c);
